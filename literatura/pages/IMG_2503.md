...
**Zdroj**: Macháček V., Dolenský M. — *Možné vzory zprávy o revizi VEZ*, vyd. lpe.cz, str. 85 / vnitřní str. 15 (**výrobní objekt**).

**Téma**: **Celkový posudek — slovní zhodnocení** — závěrečná (podpisová) strana vzorové zprávy o revizi pro výrobní objekt.

**Paralela k [IMG_2487.md](IMG_2487.md)** (rodinný dům) — strukturně totožný formulář.
