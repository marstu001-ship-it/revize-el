...
**Zdroj**: Macháček V., Dolenský M. — *Možné vzory zprávy o revizi VEZ*, vyd. lpe.cz, str. 73 / vnitřní str. 3 (**výrobní objekt**).

**Téma**: Úplná tabulka ochranných opatření pro výrobní objekt — mapování článků **ČSN 33 2000-4-41 ed.3** ↔ **ČSN EN 61 140 ed.3** včetně prostředků základní ochrany, ochrany při poruše a doplňkové ochrany.

**Téměř identická obsahově s [IMG_2472.md](IMG_2472.md)** (stejná kniha, ale tato strana je ve vzoru pro průmysl); níže uvedena kompletní tabulka pro samostatnou dohledatelnost.
